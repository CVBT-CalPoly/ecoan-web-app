...
$layout = new TLayout("report3","FancyOrange","MobileOrange");
...
$layout->blocks["top"][] = "hmenu";$page_layouts["Product_Cost_Breakdown_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="Product_Cost_Breakdown_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "Product_Cost_Breakdown";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Product_Cost_Breakdown_search.php';return false;\"");
