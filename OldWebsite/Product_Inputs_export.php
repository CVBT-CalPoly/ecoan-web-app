...
$layout->blocks["top"][] = "export";$page_layouts["Product_Inputs_export"] = $layout;
...
$xt->display("Product_Inputs_export.htm");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Product_Inputs.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Product_Inputs.csv");
