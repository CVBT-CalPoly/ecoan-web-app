...
$layout->blocks["top"][] = "search";$page_layouts["Product_Inputs_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = "Product_Inputs_search.htm";
...
$params['shortTableName'] = 'Product_Inputs';
...
if ($mode==SEARCH_SIMPLE)
{
	...
	// search fields data
	$categoryFieldParams = $pageObject->searchClauseObj->getSearchCtrlParams("ProdGrpCode");
	$categoryFieldVal = '';
	...
	$fieldParams = $pageObject->searchClauseObj->getSearchCtrlParams('ProdEngName');
	$fieldVal = '';
	...
	// search fields data
	$categoryFieldParams = $pageObject->searchClauseObj->getSearchCtrlParams("ProdEngName");
	$categoryFieldVal = '';
	if (count($categoryFieldParams))
	{
		$categoryFieldVal = $categoryFieldParams[0]['value1'];
	...
	$fieldParams = $pageObject->searchClauseObj->getSearchCtrlParams('EngModel');
	$fieldVal = '';
	if (count($fieldParams))
	{
		$fieldVal = $fieldParams[0]['value1'];
