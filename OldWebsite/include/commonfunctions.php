...
function checkTableName($shortTName, $type=false)
{
	...
	if ("Product_Group_Prices_Report" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Product_Inputs" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	...
	if ("Mix_Registry_Report" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Product_Cost_Breakdown" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
...
function GetUserPermissions($table="")
{
	...
	if($table=="Product Cost Breakdown")
	{
			$permissions =  "ADESPIM";
	}
