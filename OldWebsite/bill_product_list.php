...
$layout = new TLayout("list3","FancyOrange","MobileOrange");
...
$layout->blocks["top"][] = "recordcontrols";$page_layouts["bill_product_list"] = $layout;
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "BillNo";
				}
