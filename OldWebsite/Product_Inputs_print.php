...
$layout->blocks["top"][] = "grid";$page_layouts["Product_Inputs_rprint"] = $layout;
...
$params["templatefile"] = "Product_Inputs_rprint.htm";
$params["xt"] = &$xt;
...
if (@$_REQUEST["format"]=="excel")
{
	...
	header("Content-Disposition: attachment;Filename=Product_Inputs.xls");
...
else if (@$_REQUEST["format"]=="word")
{
	...
	header("Content-Disposition: attachment;Filename=Product_Inputs.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
