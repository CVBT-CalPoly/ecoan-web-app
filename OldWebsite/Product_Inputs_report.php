...
include("include/Product_Inputs_variables.php");
...
$layout->blocks["top"][] = "hmenu";$page_layouts["Product_Inputs_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="Product_Inputs_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "Product_Inputs";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Product_Inputs_search.php';return false;\"");
